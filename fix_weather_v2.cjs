...
export default function WeatherWidget() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center w-full md:w-64 h-[60px] bg-white/5 backdrop-blur-md rounded-xl border border-white/10 animate-pulse">
  ...
  return (
    <div className="flex items-center justify-between w-full md:w-auto gap-4 bg-white/5 hover:bg-white/10 transition-colors backdrop-blur-md px-4 py-2.5 rounded-xl border border-white/10 shadow-sm">
      <div className="flex items-center gap-3">
        <div className={\`flex items-center justify-center w-10 h-10 rounded-lg bg-black/20 shadow-inner \${info.color}\`}>
        ...
        <div className="flex flex-col justify-center">
          <div className="flex items-baseline gap-2">
            <div className="flex items-start">
              ...
              <span className="text-xs font-medium text-white/70 ml-0.5 leading-none">°C</span>
            </div>
          ...
          <div className="flex items-center gap-2.5 mt-1.5 text-[10px] font-medium text-white/70">
            <div className="flex items-center gap-1" title="Yağış Olasılığı">
